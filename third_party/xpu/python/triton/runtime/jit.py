...
from .sig_and_spec import fast_create_function_from_signature
from ..runtime.driver import driver
from ..runtime.driver import DriverConfig
...
class JITFunction(KernelInterface[T]):
    ...
    def __init__(self, fn, version=None, do_not_specialize=None, debug=None, noinline=None, repr=None,
        ...
        self.specialize_indices = [p.num for p in self.params if not p.is_constexpr and not p.do_not_specialize]
        self.do_not_specialize_indices = [p.num for p in self.params if not p.is_constexpr and p.do_not_specialize]
